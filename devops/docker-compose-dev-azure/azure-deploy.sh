...
resourcename="projecttracker"  # lower case, only
resourcegroup="projecttracker_rg"
...
# git clone https://github.com/apilogicserver/projecttracker.git
# cd projecttracker
...
az group create --name projecttracker_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group projecttracker_rg --sku S1 --is-linux
az container create --resource-group projecttracker_rg --name projecttracker --image apilogicserver/projecttracker:latest --dns-name-label projecttracker --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//projecttracker.westus.azurecontainer.io:5656'
